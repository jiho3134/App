...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder retry = new AlertDialog.Builder(MainActivity.this);
                retry.setTitle("먹이주기");
                retry.setMessage("정말 주시겠습니까 ?");
                retry.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    @Override
                ...
                retry.setNegativeButton("취소", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
